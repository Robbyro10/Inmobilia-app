...
export const OfferingCard = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-10 mb-20 bg-dark-blue md:w-3/4 w-full max-w-screen-lg mx-auto p-10 ">
        ...
        <div className="flex flex-col md:flex-row gap-5 items-center">
          <ul className="text-white flex gap-2 flex-col m-5 text-left">
            <li>
